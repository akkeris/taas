...
func checkEnv() {
	var c int
	var requiredEnv = []string{"AKKERIS_API_URL", "APP_CONTROLLER_AUTH_SECRET", "APP_CONTROLLER_URL", "DEFAULT_ORG", "DEFAULT_START_DELAY", "DIAGNOSTICDB", "ENABLE_SLACK_NOTIFICATIONS", "ES_URL", "GITHUB_TOKEN_SECRET", "KIBANA_URL", "KUBERNETES_API_SERVER", "KUBERNETES_API_VERSION", "KUBERNETES_CLIENT_TYPE", "KUBERNETES_TOKEN_SECRET", "LOG_URL", "PITDB", "PORT", "POSTBACKURL", "RERUN_URL", "SLACK_NOTIFICATION_CHANNEL", "SLACK_NOTIFICATION_URL", "VAULT_ADDR", "VAULT_TOKEN", "AWS_S3_BUCKET", "AWS_REGION", "AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY", "DIRECTORY_LISTINGS", "STRIP_PATH", "DIRECTORY_LISTINGS_FORMAT", "ARTIFACTS_URL", "LOG_TIMESTAMPS_LOCALE"}
